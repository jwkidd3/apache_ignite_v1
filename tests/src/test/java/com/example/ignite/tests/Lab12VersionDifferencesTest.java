...
/**
 * Lab 12: Version Differences Tests
 *
 ...
 *
 * NOTE: Full Ignite 3.x integration tests are in the solutions/lab12_version_differences
 * module, which uses ignite-client:3.1.0 (incompatible classpath with 2.x).
 *
 * To run 3.x integration tests:
 *   cd solutions/lab12_version_differences
 *   mvn test  (requires running Ignite 3.x Docker container)
 */
@DisplayName("Lab 12: Version Differences - 2.x Concepts & 3.x Knowledge")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class Lab12VersionDifferencesTest {
    ...
    static void startIgnite() {
        ...
        cfg.setIgniteInstanceName("lab12-test");
    ...
    void testJavaConfiguration() {
        ...
        assertThat(cfg.getIgniteInstanceName()).isEqualTo("lab12-test");
    ...
    void testCacheFirstModel() {
        var cache = ignite.getOrCreateCache("lab12-cache");
    ...
    void testCachePutGet() {
        var cache = ignite.getOrCreateCache("lab12-crud");
    ...
    void testSqlFieldsQuery() {
        var cache = ignite.getOrCreateCache("lab12-sql");
    ...
    void testTransactionModel() {
        var cacheCfg = new org.apache.ignite.configuration.CacheConfiguration<String, String>("lab12-tx");
    ...
    void testAffinityFunction() {
        var cacheCfg = new org.apache.ignite.configuration.CacheConfiguration<>("lab12-affinity");
