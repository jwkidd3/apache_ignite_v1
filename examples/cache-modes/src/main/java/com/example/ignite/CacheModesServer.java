 ...
 * Cache Modes Server
 *
 * Starts 3 server nodes and creates caches with different modes.
 *
 * Usage:
 *   mvn exec:java -Dexec.mainClass="com.example.ignite.CacheModesServer"
 */
public class CacheModesServer {
    ...
    private static Ignite startNode(int nodeNumber) {
        ...
        cfg.setIgniteInstanceName("cache-server-" + nodeNumber);
