...
/**
 * Lab 12 Exercises 13-14: Ignite 3.x Data Colocation and Distribution Zones
 *
 * Demonstrates:
 ...
 */
public class Lab12DataColocation {

    public static void main(String[] args) {
        System.out.println("=== Lab 12: Ignite 3.x Data Colocation & Distribution Zones ===\n");
        ...
        try (IgniteClient client = IgniteClient.builder()
            ...
            client.sql().executeScript(
                ...
                "DROP ZONE IF EXISTS lab12_zone");
    ...
    private static void demonstrateDistributionZones(IgniteClient client) {
        ...
        try {
            client.sql().executeScript(
                "CREATE ZONE IF NOT EXISTS lab12_zone WITH " +
                "replicas=1, partitions=25, storage_profiles='default'");
            System.out.println("  Created distribution zone 'lab12_zone':");
