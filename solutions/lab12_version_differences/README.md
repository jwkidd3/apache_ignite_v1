# Lab 12: Apache Ignite 3.x Hands-On - Solutions
...
```
lab12_version_differences/
├── pom.xml                    (ignite-client 3.1.0)
├── README.md
└── src/main/java/com/example/ignite/solutions/lab12/
    ├── Lab12Discovery.java          - Exercises 1-2: Connection, SWIM, RAFT
    ├── Lab12Configuration.java      - Exercises 3-5: HOCON, dynamic config, zones
    ├── Lab12CacheAPI.java           - Exercises 6-8: Table API, SQL queries
    ├── Lab12Transactions.java       - Exercises 9-10: Transactions, mixed SQL+KV
    ├── Lab12Compute.java            - Exercises 11-12: Compute grid, gaps
    ├── Lab12DataColocation.java     - Exercises 13-14: Distribution Zones, COLOCATE BY
    ├── Lab12Monitoring.java         - Exercises 15-16: REST, CLI, OpenMetrics
    └── Lab12ComparisonSummary.java  - Exercise 17: Full comparison + live demo
```
